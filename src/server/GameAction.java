...
public enum GameAction {
    ...
    public static final GameAction[] JAIL_ACTIONS = new GameAction[]{TRADE_OFFER, PROPERTY_MORTGAGE, PROPERTY_UNMORTGAGE, HOUSE_BUILD, HOUSE_SELL, JAIL_THROW_DICE, JAIL_PAY_BAIL, JAIL_USE_CARD};
    public static final GameAction[] SELL_ACTIONS = new GameAction[]{TRADE_OFFER, TRADE_ACCEPT, TRADE_REJECT, PROPERTY_MORTGAGE, HOUSE_SELL};
